          ...
          <form className="space-y-5" onSubmit={handleSchedule}>
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full bg-slate-50 px-5 py-4 border-slate-200 border rounded-2xl text-slate-900 text-sm placeholder-slate-400 outline-none resize-none"
              />
              <div
            ...
            {published.length === 0 ? (
              ...
              published.map((post) => (
                ...
                >
                  ...
                  <p className="line-clamp-2 max-w-4/5 text-sm text-slate-500">
                    {post.content}
                  </p>
                </div>
              ))
